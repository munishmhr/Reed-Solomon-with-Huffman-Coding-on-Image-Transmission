...
R=I(:,:,1); G=I(:,:,2); B=I(:,:,3);
I = .299*R + .587*G + .114*B;
imwrite(I,'self Gray Scale standard Quantization grade 1.jpg');
...
gray = I;
imwrite(I,'self subsampled Gray Scale standard Quantization grade 1.jpg');
...
I_Standard = round(I./(1*jpegTableForDivide));
...
dlmwrite('BitStream.txt',BitStream{1},'delimiter',' ');

%% Reed Solomon Encoding and decoding 
'Starting RS coding'
[decodedBlockStreamCompression,SyndromeCodeWordStream] = RSEncoDeco(BitStream{1});


%% %%%%%%%%%%%%%%%%%%%%%%%%% Image Decoding %%%%%%%%%%%%%%%%%%%%%%%%%%%
'Starting huffmandecoding';
huffmandecoding(decodedBlockStreamCompression);
