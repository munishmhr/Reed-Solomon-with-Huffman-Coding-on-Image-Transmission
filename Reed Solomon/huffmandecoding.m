        ...
        while(EOB == 1)
            ...
            for index = 1 : 1 : length(binaryAfterDc)
                ...
                if(index == 200)
                    ...
                    for index4 = 1 : 1 : length(binaryAfterDc)
                        'inside'
                        if(strmatch('1010',binaryAfterDc(index4:index4+3)))
                            binaryAfterDc(1:index4+3)
                            lengthAcBinary = index4+3;
                            AcCategory = 2;
                            runlength = 1 ;
                            break;
                        end
...
if (~isempty(binaryAfterDc))
            ...
            run = num2str(runlength(1));
            ACcarter = num2str(AcCategoryDecoded);
            
            test =  binaryAfterDc;
            oneBlock = [num2str(runlength(1)),' ',num2str(AcCategoryDecoded)];
